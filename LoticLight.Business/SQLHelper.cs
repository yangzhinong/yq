...
namespace LoticLight.Business
{
        ...
        public sealed class SqlHelper
        {
            ...
            private static string sCnn= ConfigurationManager.ConnectionStrings["cnn"].ConnectionString;
            private SqlHelper() { }
        ...
        public static int ExecuteNonQueryText(string commandText, params SqlParameter[] commandParameters)
        {
            return ExecuteNonQuery(sCnn, CommandType.Text, commandText, commandParameters);
        }

        public static int ExecuteNonQueryCmd(string commandText, params SqlParameter[] commandParameters)
        {
            return ExecuteNonQuery(sCnn, commandText, commandParameters);
        }
        ...
        public static SqlDataReader ExecuteReader(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
          ...
          public static object ExecuteScalarText( string sql, params SqlParameter[] commandParameters)
            {
                return ExecuteScalar(sCnn, CommandType.Text, sql, commandParameters);
            }

            public static object ExecuteScalarCmd(string spName, params SqlParameter[] commandParameters)
            {
                return ExecuteScalar(sCnn, CommandType.StoredProcedure, spName, commandParameters);
            }
