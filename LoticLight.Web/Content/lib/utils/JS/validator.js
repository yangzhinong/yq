...
function ValidationMessage(obj, Validatemsg) {
    try {
        ...
        if (obj.hasClass('form-control') || obj.hasClass('ui-select') || obj.hasClass('ui-select2')) {
            obj.parent().addClass('has-error');
        }
        if (obj.hasClass('ui-select') || obj.hasClass('ui-select2')) {
            $('.input-error').remove();
        }
        obj.change(function () {
            if (obj.val()) {
