...
{
    public class NPSAController : BaseController
    {
        ...
        public ActionResult GridData(Pagination pagination,string keyword = "")
        {
            ...
            var data = Business.YqNPSAService.Instance.LoadPagerEntities(
        ...
        public ActionResult SaveForm(Model.YqNPSA obj)
        {
            if (string.IsNullOrEmpty(obj.Id))
            {
                obj.Id = Guid.NewGuid().ToString();
                Business.YqNPSAService.Instance.AddEntities(obj);
            }
            else
            {
                Business.YqNPSAService.Instance.UpdateEntities(obj);
            }
        ...
        {
            var data = Business.YqNPSAService.Instance.FindEntities(keyValue);
            return Json(data, JsonRequestBehavior.AllowGet);
        }
        [SimpleCheckPermission("admin")]
        public ActionResult Delete(string keyValue)
        {
            var obj = Business.YqNPSAService.Instance.FindEntities(keyValue.Trim());
            if (obj != null)
            {
                Business.YqNPSAService.Instance.RemoveEntities(obj);
